...
public class MmdSkinRegisterCommon {
    ...
    public static void Register() {
        channel = NetworkRegistry.newSimpleChannel(new Identifier("3d-skin", "network_pack"), () -> networkVersion, NetworkRegistry.acceptMissingOr(networkVersion), (version) -> version.equals(networkVersion));
